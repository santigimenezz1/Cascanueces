...
const Home = () => {
  ...
  return (
   ...
   <Link 
   to={"/categoria"}><TarjetaGrid titulo={"Frutos secos naturales"} imagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1691788016/CASCANUCES%20SALUDABLE/KoRo-Naturbelassene-Nu_CC_88sse-Gro_C3_9Fpackung-gu_CC_88nstig-online-kaufen-bestellen-onlineshop-ohne-Zucker-ohne-Salz-ohne-Gewu_CC_88rz_q7wze2.jpg"}/>
   </Link> 
   <Link  to={"/categoria"}>
   ...
   <Link  to={"/categoria"}>
   <TarjetaGrid titulo={"Frutos secos especiados"} imagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1691804092/CASCANUCES%20SALUDABLE/BIO_Kokosmilch_01_icjeh7.jpg"} />
   </Link>
   <Link  to={"/categoria"}>
   <TarjetaGrid titulo={"Miz de frutas secas"} imagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1691804080/CASCANUCES%20SALUDABLE/MANG_003_NEU_03_hydzcx.jpg"} />
   </Link> 
   <Link  to={"/categoria"}>
   ...
   <Link  to={"/categoria"}>
   <TarjetaGrid titulo={"Cremas de frutos secos"} imagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1691804485/CASCANUCES%20SALUDABLE/CREME_001_01_AK_e76hgy.jpg"} />
   </Link>
   <Link  to={"/categoria"}>
   <TarjetaGrid titulo={"Frutos secos especiados"} imagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1691807928/CASCANUCES%20SALUDABLE/RIEGEL_11_01_plmabt.jpg"} />
   </Link>
   <Link  to={"/categoria"}>
   <TarjetaGrid titulo={"Miz de frutas secas"} imagen={"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1691807991/CASCANUCES%20SALUDABLE/BLISS_021_04_la6aic.jpg"} />
   </Link>
    </div>
    <FondoFijoProducto />
