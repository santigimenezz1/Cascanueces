...
const IconoWhatsapp = () => {
    ...
    return (
      ...
      <button style={{border:"none", cursor:"pointer", backgroundColor: "#25D366", borderRadius:"50px", padding:"3px"}}  onClick={handleWhatsAppClick}><WhatsAppIcon fontSize='large' color='white' style={{fontSize:"50px", color:"white", paddin:"5px", backgroundColor: "#25D366", borderRadius:"50px"}} /> </button>
      </div>
    );
  };
